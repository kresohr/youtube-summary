    ...
    <main class="container">
      ...
      <section class="admin-section">
        ...
        <form @submit.prevent="addChannel" class="add-channel-form">
          <div class="form-row">
            ...
            <div class="form-group">
              <label for="channelUrl">Channel URL (optional)</label>
              <input
                id="channelUrl"
      ...
      <section class="admin-section">
        <div class="section-header">
          ...
          <button class="btn-primary" @click="triggerFetch" :disabled="triggering">
...
async function addChannel() {
  ...
  try {
    await api.post('/channels', {
      ...
      channelUrl: newChannel.channelUrl || undefined,
    });

    showToast(`Channel "${newChannel.channelName}" added successfully!`);
    ...
    if (err && typeof err === 'object' && 'response' in err) {
      ...
      showToast(axiosErr.response?.data?.error || 'Failed to add channel', 'error');
    } else {
...
async function deleteChannel(channel: Channel) {
  if (!confirm(`Are you sure you want to delete "${channel.channelName}" and all its videos?`)) {
    return;
  }
